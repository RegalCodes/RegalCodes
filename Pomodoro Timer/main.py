...
start_button = Button(text="Start", bg="white",font=("Courier", 15, "bold"), highlightthickness=0, command=start_timer)
start_button.grid(column=0,row=3)

reset_button = Button(text="Reset", bg="white", font=("Courier", 15, "bold"), command=reset_timer)
reset_button.grid(column=3,row=3)

check_marks = Label(fg=GREEN, bg=YELLOW, font=("Courier", 20, "bold"))
